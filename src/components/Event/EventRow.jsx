...
const EventRow = ({ event }) => {
    ...
    return (
        <motion.div 
            ...
            className="grid grid-cols-1 md:grid-cols-10 gap-6 items-center bg-base-100 p-6 rounded-2xl shadow-sm hover:shadow-xl hover:ring-2 hover:ring-primary transition-all duration-300 group"
        >
            <div className="md:col-span-2">
                <p className="font-bold text-lg">{new Date(event.date).toLocaleDateString('en-GB', { month: 'long', day: 'numeric' })}</p>
            ...
            <div className="md:col-span-2 text-left md:text-right">
                <a href="#" className="inline-flex items-center font-bold py-2 px-4 rounded-lg bg-primary group-hover:bg-secondary group-hover:text-primary-content transition-all">
