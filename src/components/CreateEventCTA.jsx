...
const CreateEventCTA = () => {
    return (
        <section className="relative bg-cover bg-center" style={{ backgroundImage: "url('https://placehold.co/1600x600/1F2937/FFFFFF?text=Community+in+Action')" }}>
            ...
            <div className="mx-auto max-w-2xl">
                <div className="text-center bg-white/10 backdrop-blur-md p-8 sm:p-12 rounded-2xl border border-white/20">
                    ...
                    <div className="mt-10 flex items-center justify-center">
                        <a href="#" className="rounded-md bg-secondary px-6 py-3 text-lg font-semibold text-white shadow-sm hover:bg-secondary-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary transition-transform hover:scale-105">Start an Event Today</a>
                    </div>
                </div>
            </div>
        </div>
